package com.tao.vehiclemvdemo.android.utils.prefs;
...
import com.tao.vehiclemvdemo.android.tlog.TLogActivity;
...
public class DroidPlannerPrefs {
    ...
    private static final String DEFAULT_TCP_SERVER_IP = "134.175.130.23";

    public static final String PREF_TCP_SERVER_PORT = "pref_server_port";
    private static final String DEFAULT_TCP_SERVER_PORT = "8890";
...
//        @ConnectionType.Type int connectionType = Integer.parseInt(prefs.getString(PREF_CONNECTION_TYPE, DEFAULT_CONNECTION_TYPE).trim());
        return ConnectionType.TYPE_TCP;
    }
