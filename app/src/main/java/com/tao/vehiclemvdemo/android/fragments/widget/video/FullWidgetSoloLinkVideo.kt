...
import com.tao.vehiclemvdemo.android.dialogs.LoadingDialog
import com.tao.vehiclemvdemo.android.fragments.widget.video.BaseVideoWidget
            ...
            override fun onSuccess() {
                ...
                val gimbalTracker = object : View.OnTouchListener {
                    ...
                    private fun moveCopter(view: View, event: MotionEvent): Boolean {
                        ...
                        val touchWidth = touchCircleImage.width
                        val touchHeight = touchCircleImage.height
