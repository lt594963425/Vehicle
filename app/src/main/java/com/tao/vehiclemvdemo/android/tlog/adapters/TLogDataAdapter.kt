package com.tao.vehiclemvdemo.android.tlog.adapters
...
import com.tao.vehiclemvdemo.android.droneshare.data.SessionContract.SessionData
...
class TLogDataAdapter(val app: DroidPlannerApp, val fragmentMgr: FragmentManager, val selectedSessionId: Long) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val clearSession = containerView.findViewById(R.id.clear_tlog_session) as ImageView
        val editLabel = containerView.findViewById(R.id.rename_tlog_session)as ImageView
