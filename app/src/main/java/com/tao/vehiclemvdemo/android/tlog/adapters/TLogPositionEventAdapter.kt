...
import com.tao.vehiclemvdemo.android.tlog.viewers.TLogPositionViewer
...
import com.tao.vehiclemvdemo.android.view.adapterViews.AbstractRecyclerViewFooterAdapter
...
class TLogPositionEventAdapter(context: Context?, recyclerView: RecyclerView) :
    ...
    override fun onCreateBasicItemViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val thumbnail = container.findViewById(R.id.event_thumbnail) as RelativeLayout
