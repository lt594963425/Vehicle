...
import com.tao.vehiclemvdemo.android.activities.EditorActivity
import com.tao.vehiclemvdemo.android.droneshare.data.SessionContract
import com.tao.vehiclemvdemo.android.tlog.adapters.TLogPositionEventAdapter
import com.tao.vehiclemvdemo.android.tlog.event.TLogEventListener
import com.tao.vehiclemvdemo.android.tlog.event.TLogEventMapFragment
import com.tao.vehiclemvdemo.android.utils.MapUtils
import com.tao.vehiclemvdemo.android.utils.SpaceTime
import com.tao.vehiclemvdemo.android.view.FastScroller
...
class TLogPositionViewer : TLogViewer(), TLogEventListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?){
        ...
        (view.findViewById(R.id.drone_location_button) as FloatingActionButton).visibility = View.GONE

        val floatingActionButton : FloatingActionButton =  view.findViewById(R.id.zoom_to_fit_button) as FloatingActionButton
        floatingActionButton.setOnClickListener {
            floatingActionButton.visibility =View.VISIBLE

        }
        (view.findViewById(R.id.zoom_to_fit_button) as FloatingActionButton).apply {
