...
import com.tao.vehiclemvdemo.android.fragments.widget.WidgetsListPrefFragment;
import com.tao.vehiclemvdemo.R;
import com.tao.vehiclemvdemo.android.DroidPlannerApp;
import com.tao.vehiclemvdemo.android.activities.helpers.MapPreferencesActivity;
        ...
        if(widgetsPref != null){
            widgetsPref.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(Preference preference) {
                    new WidgetsListPrefFragment().show(getFragmentManager(), "WidgetsListPrefFragment");
                    return true;
                }
            });
        }
            ...
            defaultSpeedPref.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                ...
                public boolean onPreferenceChange(Preference preference, Object newValue) {
                    ...
                    try {
                        ...
                        if (context != null) {
                            Toast.makeText(context,"速度不正确！", Toast.LENGTH_LONG).show();
                        }
                    }
                    return false;
                }
            ...
            altPref.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                ...
                public boolean onPreferenceChange(Preference preference, Object newValue) {
                    ...
                    try {
                        ...
                        if(context != null){
                            Toast.makeText(context,  "高度不正确", Toast.LENGTH_LONG).show();
                        }
                    }
                    return false;
                }
