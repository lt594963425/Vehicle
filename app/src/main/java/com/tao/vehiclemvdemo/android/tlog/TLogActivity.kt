package com.tao.vehiclemvdemo.android.tlog
...
import com.tao.vehiclemvdemo.android.tlog.adapters.TLogDataAdapter
import com.tao.vehiclemvdemo.android.tlog.adapters.TLogViewerAdapter
...
import com.tao.vehiclemvdemo.android.activities.DrawerNavigationUI
import com.tao.vehiclemvdemo.android.dialogs.OkDialog
 ...
 */
public class TLogActivity : DrawerNavigationUI(), TLogDataAdapter.Listener, TLogDataProvider {
    ...
    private var currentSessionData: SessionContract.SessionData? = null

    private val loadingProgress by lazy {
        findViewById(R.id.progress_bar_container) as ProgressBar
    }
                            ...
                            object : SupportEditInputDialog.Listener{
                                override fun onOk(dialogTag: String?, input: CharSequence?) {
                                    if (TextUtils.isEmpty(input)) {
                                        Toast.makeText(applicationContext,"请输入一个有效的条目!", Toast.LENGTH_LONG).show();
