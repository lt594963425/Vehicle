package com.tao.vehiclemvdemo.android.maps;
...
public interface DPMap {
	 ...
	 * @param maximumZ
     */
	void downloadMapTiles(MapDownloader mapDownloader, VisibleMapArea mapRegion, int minimumZ, int maximumZ);
	...
	class VisibleMapArea implements Parcelable {
		...
		public static final Creator<VisibleMapArea> CREATOR = new Creator<VisibleMapArea>() {
