...
public class MAVLinkClient implements DataLink.DataLinkProvider<MAVLinkMessage> {
    ...
    private final MavLinkConnectionListener mConnectionListener = new MavLinkConnectionListener() {
        ...
        public void onReceivePacket(final MAVLinkPacket packet) {
            LogUtil.e("App","-------------MAVLinkClient------onReceivePacket-----"+packet.compid);
        ...
        public void onConnectionStatus(final LinkConnectionStatus connectionStatus) {
            ...
            LogUtil.e("App","-------------MAVLinkClient------onConnectionStatus-----"+connectionStatus.getStatusCode());
    ...
    public synchronized void openConnection() {
        LogUtil.e("App","-------------MAVLinkClient--------------openConnection-------");
        ...
        if (mavlinkConn == null) {
            switch (connectionType) {
                ...
                case ConnectionType.TYPE_TCP:
                    ...
                    String tcpServerIp = paramsBundle.getString(ConnectionType.EXTRA_TCP_SERVER_IP);
                    int tcpServerPort = paramsBundle.getInt(ConnectionType.EXTRA_TCP_SERVER_PORT, ConnectionType.DEFAULT_TCP_SERVER_PORT);
                    LogUtil.e("TCP", "134.175.130.23" + "------------------" + 8890);
                    mavlinkConn = new AndroidTcpConnection(context, "134.175.130.23", 8890, new WifiConnectionHandler(context));
