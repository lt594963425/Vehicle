...
public class MavLinkDroneManager extends DroneManager<MavLinkDrone, MAVLinkPacket> implements MagnetometerCalibrationImpl.OnMagnetometerCalibrationListener {
    ...
    public void onVehicleTypeReceived(FirmwareType type) {
        ...
        switch (type) {
            case ARDU_COPTER:
                ...
                Timber.i("实例化翼机自动驾驶仪.");
                LogUtil.e("App", "------------MavLinkDroneManager-------实例化翼机自动驾驶仪----------");
            ...
            case ARDU_SOLO:
                ...
                LogUtil.e("App", "------------MavLinkDroneManager-------Instantiating ArduSolo autopilot----------");
            ...
            case ARDU_PLANE:
                ...
                LogUtil.e("App", "------------MavLinkDroneManager-------Instantiating ArduPlane autopilot----------");
            ...
            case PX4_NATIVE:
                ...
                LogUtil.e("App", "------------MavLinkDroneManager-------Instantiating PX4 Native autopilot.----------");
            ...
            case GENERIC:
                ...
                LogUtil.e("App", "------------MavLinkDroneManager-------Instantiating Generic mavlink autopilot.----------");
    ...
    protected void doConnect(String appId, DroneApi listener, ConnectionParameter connParams) {
        if (mavClient.isDisconnected()) {
            ...
            LogUtil.e("App", "--------------------isDisconnected---------------------" + appId);
            mavClient.openConnection();
        } else {
            LogUtil.e("App", "--------------------isConnected---------------------" + appId);
            if (isConnected()) {
    ...
    protected void doDisconnect(String appId, DroneApi listener) {
        ...
        LogUtil.e("App", "--------------------doDisconnect---------------------" + appId);
    ...
    public void notifyReceivedData(MAVLinkPacket packet) {
        LogUtil.e("App", "notifyReceivedData---------------------" + packet.compid);
        MAVLinkMessage receivedMsg = packet.unpack();
        if (receivedMsg == null) {
//            LogUtil.e("App", "--------------------MAVLinkMessage---------------------无数据" );
            return;
        }
//        LogUtil.e("App", "--------------------MAVLinkMessage---------------------数据" );
        if (receivedMsg.msgid == msg_command_ack.MAVLINK_MSG_ID_COMMAND_ACK) {
            LogUtil.e("App", "onReceivedMavLinkMessage---------------------1");
            msg_command_ack commandAck = (msg_command_ack) receivedMsg;
            handleCommandAck(commandAck);
        } else {
            LogUtil.e("App", "onReceivedMavLinkMessage---------------------2");
    ...
    public void onConnectionStatus(LinkConnectionStatus connectionStatus) {
        ...
        LogUtil.e("App", "onConnectionStatus---------------------" + connectionStatus.toString());
    ...
    protected boolean executeAsyncAction(Action action, ICommandListener listener) {
        ...
        LogUtil.e("App", "--------------------executeAsyncAction---------------------");
        switch (type) {
            //FOLLOW-ME ACTIONS
